          ...
          <div class="navbar-header">
           ...
           <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Projects</a>
                <ul class="dropdown-menu">
                  <li><a href="https://www.mauzosheet.com/">MauzoSheet</a>
                  </li>
                  <li><a href="#" >Drones</a>
                  </li>
                </ul>
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  ...
                  <div class="team-descr font-alt">
                    ...
                    <div class="team-role">ELCTRONICS ENGINEER</div>
                  </div>
                </div>
              </div>
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="assets/images/toni.jpg" alt="Member Photo"/>
                    <div class="team-detail">
                      <h5 class="font-alt">Mambo..</h5>
                      <p class="font-serif"></p>
                      <div class="team-social"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-dribbble"></i></a><a href="#"><i class="fa fa-skype"></i></a></div>
                    </div>
                  </div>
                  <div class="team-descr font-alt">
                    <div class="team-name">ANTHONIA LUMA</div>
                    <div class="team-role">MARKETING AND STRATEGIC PLANNER</div>
                  </div>
                </div>
              </div>
            </div>
